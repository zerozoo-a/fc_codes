...
declare type ReturnFlatMapType<A extends Iterable<unknown> | AsyncIterable<unknown>, B = unknown> = A extends Iterable<unknown> ? IterableIterator<DeepFlatSync<B, 1>> : A extends AsyncIterable<unknown> ? AsyncIterableIterator<DeepFlat<Awaited<B>, 1>> : never;
/**
